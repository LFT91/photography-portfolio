...
import { revalidateCatalog } from "@/app/actions/revalidate-catalog";
import { useAdmin } from "@/components/admin/AdminProvider";
import { PhotoImage } from "@/components/PhotoImage";
import { isRetiredCollection } from "@/lib/retired-collections";
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 sm:py-16">
      ...
      {holdPreviewPhoto && safeHoldPreviewIndex != null ? (
        <div
          className="fixed inset-0 z-50 flex cursor-zoom-out items-center justify-center bg-ink/92 p-4 sm:p-8"
          role="dialog"
          aria-modal="true"
          aria-label="Unassigned photo preview"
          onClick={() => setHoldPreviewIndex(null)}
        >
          <div className="relative flex max-h-full w-full max-w-5xl flex-col gap-4">
            <div
            ...
            >
              <button
                ...
                className="absolute left-0 z-10 cursor-pointer border border-line bg-ink/70 px-3 py-2 font-brand text-xl text-paper-dim transition-colors hover:text-paper disabled:opacity-30 sm:left-2"
              ...
              <button
                ...
                className="absolute right-0 z-10 cursor-pointer border border-line bg-ink/70 px-3 py-2 font-brand text-xl text-paper-dim transition-colors hover:text-paper disabled:opacity-30 sm:right-2"
