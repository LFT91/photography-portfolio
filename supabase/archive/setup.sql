...
-- Canonical bootstrap: apply supabase/migrations/*.sql in timestamp order,
-- then supabase/bootstrap-admin.sql. This snapshot predates is_app_admin()
-- and allows any authenticated user to write photos.
--
-- Fatni Photography — historical SQL Editor snapshot (fresh project)
