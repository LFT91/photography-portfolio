-- Fatni Photography: photos table + storage policies
...
create table if not exists public.photos (
  ...
  night_kind text check (night_kind in ('Street', 'Urban', 'Landscape', 'Astro')),
...
-- Authenticated owners can manage (tighten to your email in production)
